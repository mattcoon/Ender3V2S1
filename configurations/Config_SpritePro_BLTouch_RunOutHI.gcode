...
C101 X230 Y231 Z240    ; Set XYZ Max position
C102 X230 Y230         ; Set a bed size of 230x230
C125 X230 Y221 Z20     ; setup the park position
...
M851 X-31.80 Y-40.50   ; Set offset to nozzle for probe
...
; customization
C810 A0 B13 C6 D13 E14    ; sets up the toolbar shortcuts A..E to funtions 0..16
